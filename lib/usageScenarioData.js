...
class UsageScenarioData {
  ...
  initializeImplementVariant(scenarioName, variantName) {
    ...
    this.usageScenarios.push(variantInfo);
  }
  ...
  getVariantInfoByNames(scenarioName, variantName) {
    ...
    const matches = this.usageScenarios.filter(
      item => item.scenario == scenarioName && item.name == variantName
    );
  ...
  initializeImplementNew(scenarioName, variantName) {
    ...
    if (this.uS[scenarioName]) {
      this.uS[scenarioName].variants.push(variantInfo);
    } else {
      this.uS[scenarioName] = {
        name: scenarioName,
  ...
  getVariantInfoByNamesNew(scenarioName, variantName) {
    ...
    //search for name of usage scenario and  implementvariant
    const scenario = this.uS[scenarioName];
...
module.exports = UsageScenarioData;
